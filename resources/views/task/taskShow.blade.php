...
@section('content')
<div class="w-full max-h-[70vh] flex flex-row p-2">
    ...
    <form method="POST" class="modern-form">
        ...
        <div class="form-group">
            ...
            <textarea name="description" rows="3" placeholder="Description détaillée...">{{ old('description', $task->description ?? '') }}</textarea>
        </div>
        ...
        <div class="form-group">
            ...
            <select class="select2" name="dependance[]" multiple="multiple">
