...
@section('content')
  ...
  <section id="tasks" class="py-16 text-center bg-[#4F96FF] bg-opacity-40">
    <h2 class="text-3xl font-semibold mb-4">
        <i class="fas fa-list-ul mr-2"></i>Gérez vos Tâches Facilement
    </h2>    
    ...
    <div class="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
      <div class="card bg-[#61D0A7]">
        <h3 class="text-xl font-semibold mb-4">
            <i class="fas fa-list mr-2"></i>Organisez vos Tâches
        </h3>
  ...
  <section id="budget" class="bg-[#F3F4F6] bg-opacity-40 py-16 text-center">
    <h2 class="text-3xl font-semibold mb-4">
        <i class="fas fa-wallet mr-2"></i>Suivi de Votre Budget
    </h2>
